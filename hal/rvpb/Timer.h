#ifndef RVPB_TIMER_H_
#define RVPB_TIMER_H_
...
{
    uint32_t        timerxload;     // 0x00 (aim)
    uint32_t        timerxvalue;    // 0x04 (decrease)
...
#define TIMER_FREERUNNING   0 /*timerxload OFF*/
#define TIMER_PERIOIC       1 /*timerxload ON*/
